...
Private.tumblr.favorite = function( req, connection, invert ) {
	...
	var url;
	if( invert ) {
		url = 'http://api.tumblr.com/v2/user/unlink';
	} else {
...
Private.facebook.favorite = function( req, connection, invert ) {
	...
	var query = { 'method': 'delete' }, url = 'https://graph.facebook.com/' + target_id + '/likes';
...
Private.facebook.edit = function( req, connection ) {
	...
	var query, url = 'https://graph.facebook.com/' + req.target.facebook.id;
	if( 'note' === req.data.type ) {
		query = Private.to.facebook.note( req.data );
	} else if( 'comment' === req.data.type ) {
		query = Private.to.facebook.comment( req.data );
...
Private.github.favorite = function( req, connection ) {
	...
	var target_id = ( 'undefined' !== typeof req.target && 'undefined' !== typeof req.target.github && 'undefined' !== typeof req.target.github.id ) ? req.target.github.id : null;
...
Private.linkedin.favorite = function( req, connection ) {
	...
	var query;
	var url;
	var target_id = ( 'undefined' !== typeof req.target && 'undefined' !== typeof req.target.linkedin && 'undefined' !== typeof req.target.linkedin.id ) ? req.target.linkedin.id : null; 
