...
Private.yahoo.post = function( req ) {
	...
	if( 'comment' === req.type ) {
		...
		var postbody = JSON.stringify( query );
		var callback = function( status_code, data ) {
			console.log("FIRST",typeof status_code, status_code);
			...
			var res = Private.request.put( Private.service.yahoo, url, token, secret, postbody, 'application/json', function( status2, data2 ) {
