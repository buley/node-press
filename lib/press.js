...
Private.twitter.post = function( req ) {
	...
	var callback = function( data ) { console.log( 'Twitter post posted', data ) };

	return Private.request.post( Private.service.twitter, url, token, secret, postbody, null, callback );
