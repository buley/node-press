...
Private.facebook.post = function( req ) {
	...
	//var res = Private.request.post( Private.service.facebook, url, token, secret, postbody, '', callback );
...
Private.twitter.post = function( req ) {
	...
	Private.service.twitter.get( "https://api.twitter.com/1/account/verify_credentials.json", token, secret, function (error, data, result ) {
		console.log("VERIFIFED",error,data,result);
		console.log('at',token,secret);
	} );
	console.log("DOING POST",typeof Private.service.twitter, url, token, secret, postbody, '', callback);
	//var res = Private.request.post( Private.service.twitter, url, token, secret, postbody, '', callback );
	//var res = Private.request.get( Private.service.twitter, url, token, secret, callback );
	var res = Private.service.twitter._performSecureRequest( token, secret, "GET", url, null, postbody, null, callback );

	//var res = Private.service.twitter.post( url, token, secret, postbody, null, callback );	
	console.log("RESSSSULT");
	console.log(res);
};
