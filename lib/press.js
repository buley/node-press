...
Private.tumblr.post = function( req, connection ) { 
	var own_callback = function( id, url ) {
		...
		if( 'undefined' !== typeof req.data.id ) {
			req.data.upstream_duplicates.newsgregator = req.data.id;
			delete req.data.id;
		}
...
Private.facebook.post = function( req, connection ) {
	var own_callback = function( id, url ) {
		...
		req.data.upstream_duplicates.facebook = id;
		if( 'undefined' !== typeof req.data.id ) {
			req.data.upstream_duplicates.newsgregator = req.data.id;
			delete req.data.id;
		}
...
Private.linkedin.post = function( req, connection ) {
	var own_callback = function( id, url ) {
		...
		req.data.upstream_duplicates.linkedin = id;
		if( 'undefined' !== typeof req.data.id ) {
			req.data.upstream_duplicates.newsgregator = req.data.id;
			delete req.data.id;
		}
