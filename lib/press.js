...
Private.twitter.unpost = function( req, connection ) {
	...
	if( 'comment' === req.type ) {
		...
		var target_id = null;
		if( 'undefined' !== typeof req.data && 'undefined' !== typeof req.data.target && 'undefined' !== typeof query.target.ids ) {
...
Private.windows.unpost = function( req, connection ) { return false; };
