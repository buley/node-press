	...
	var callback = function( status_code, data ) {
		...
		if( 'undefined' !== typeof data ) {
			...
			if( 'undefined' !== typeof data.id ) {
				...
				Private.request.get( Private.service.facebook, profile_url, token, secret, function( status_code_3, data_3) {
					    console.log('statuscode3',typeof status_code_3, status_code_3, 'data3', typeof data_3, data_3 );
					    console.log("BUILD ID HERE",note_item_id);
					    item_id = 'user_id_here_' + note_item_id;
