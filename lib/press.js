...
Private.tumblr.post = function( req ) { 
	...
	var callback = function( status_code,data ) {
		...
		console.log("GETTING",'https://api.tumblr.com/v2/blog/' + req.data.target.ids.tumblr + '/posts?id=' + item_id);
		var res2 = Private.request.get( Private.service.tumblr, 'https://api.tumblr.com/v2/blog/' + req.data.target.ids.tumblr + '/posts?id=' + item_id + '&api_key=' + token, token, secret, function(res2,res3) {
