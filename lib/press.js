...
Private.github.post = function( req ) {
	...
	console.log("DOING POST",typeof Private.service.github, url, token, secret, postbody, contenttype, callback);

	var res = Private.request.post( Private.service.github, url, token, secret, postbody, contenttype, callback );
	console.log("RESSSSULT", res);
