...
Private.twitter.post = function( req ) {
	...
	if( 'comment' === req.type ) {
		...
		var callback = function( status_code, data ) {
			...
			var item_url = null;
			/*
			 STRING: "{\"id_str\":\"174683755255050241\",\"retweeted\":false,\"retweet_count\":0,\"created_at\":\"Wed Feb 29 02:33:47 +0000 2012\",\"geo\":null,\"in_reply_to_status_id_str\":null,\"in_reply_to_user_id\":null,\"in_reply_to_user_id_str\":null,\"user\":{\"is_translator\":false,\"id\":497413336,\"favourites_count\":0,\"profile_background_color\":\"C0DEED\",\"lang\":\"en\",\"geo_enabled\":false,\"location\":null,\"profile_background_image_url\":\"http:\\/\\/a0.twimg.com\\/images\\/themes\\/theme1\\/bg.png\",\"utc_offset\":null,\"profile_link_color\":\"0084B4\",\"profile_background_image_url_https\":\"https:\\/\\/si0.twimg.com\\/images\\/themes\\/theme1\\/bg.png\",\"name\":\"Newsgregator\",\"profile_image_url\":\"http:\\/\\/a3.twimg.com\\/sticky\\/default_profile_images\\/default_profile_0_normal.png\",\"time_zone\":null,\"followers_count\":0,\"default_profile\":true,\"protected\":false,\"profile_use_background_image\":true,\"following\":false,\"id_str\":\"497413336\",\"profile_text_color\":\"333333\",\"listed_count\":0,\"description\":null,\"contributors_enabled\":false,\"profile_sidebar_border_color\":\"C0DEED\",\"follow_request_sent\":false,\"friends_count\":0,\"url\":null,\"statuses_count\":18,\"screen_name\":\"Newsgregator\",\"created_at\":\"Sun Feb 19 23:42:49 +0000 2012\",\"profile_background_tile\":false,\"show_all_inline_media\":false,\"profile_image_url_https\":\"https:\\/\\/si0.twimg.com\\/sticky\\/default_profile_images\\/default_profile_0_normal.png\",\"profile_sidebar_fill_color\":\"DDEEF6\",\"notifications\":false,\"default_profile_image\":true,\"verified\":false},\"in_reply_to_status_id\":null,\"favorited\":false,\"in_reply_to_screen_name\":null,\"entities\":{\"user_mentions\":[],\"hashtags\":[],\"urls\":[]},\"truncated\":false,\"contributors\":null,\"place\":null,\"source\":\"\\u003Ca href=\\\"http:\\/\\/www.wirecasts.com\\\" rel=\\\"nofollow\\\"\\u003EWirecasts\\u003C\\/a\\u003E\",\"id\":174683755255050241,\"coordinates\":null,\"text\":\"&lt;strong&gt;Shiny&lt;\\/strong&gt;!.\"}"*
			 * */
...
Private.yahoo.post = function( req ) {
	...
	if( 'comment' === req.type ) {
		...
		var callback = function( status_code, data ) {
			...
			var res = Private.request.put( Private.service.yahoo, url, token, secret, postbody, 'application/json', function() {
		
				console.log("YAHOO", item_id, item_url, data );
				var item_id = data.id;
				var item_url = null;
...
Private.windows.post = function( req ) { 
	...
	var callback = function( data, status_code ) {
		console.log('xxx',typeof data, typeof status_code);
		var item_id = data.id;
		var item_url = null;
