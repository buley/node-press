...
Private.github.favorite = function( req, connection ) {
	...
	var target_id = ( 'undefined' !== typeof req.target && 'undefined' !== typeof req.target.github && 'undefined' !== typeof req.target.github.id ) ? req.target.github.id; 
...
Private.linkedin.favorite = function( req, connection ) {
	...
	var query;
	var url;
	var target_id = ( 'undefined' !== typeof req.target && 'undefined' !== typeof req.target.linkedin && 'undefined' !== typeof req.target.linkedin.id ) ? req.target.linkedin.id; 
