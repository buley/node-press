...
Private.post = function( oauth, url, oauth_token, oauth_token_secret, post_body, post_content_type, callback ) {
	return oauth.post( url, oauth_token, oauth_token_secret, post_body, post_content_type, callback );
};

Private.get = function( oauth, url, oauth_token, oauth_token_secret, callback, extra_headers ) {
	return oauth.get( url, oauth_token, oauth_token_secret, callback, extra_headers );
};

Private.put = function( oauth, url, oauth_token, oauth_token_secret, post_body, post_content_type, callback ) {
	return oauth.put( url, oauth_token, oauth_token_secret, post_body, post_content_type, callback );
};

Private.delete = function( oauth, url, oauth_token, oauth_token_secret, callback ) {
...
Private.facebook.post = function( req ) { return false; };
...
Private.twitter.post = function( req ) {
	...
	var url = 'https://dev.twitter.com/docs/api/1/post/statuses/update';
	Private.post( Private.service.twitter, url, oauth_token, oauth_token_secret, post_body, post_content_type, callback );
	return false;
};
