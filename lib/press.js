...
Private.twitter.post = function( req ) {
	...
	//return Private.request.post( Private.service.twitter, url, token, secret, postbody, '', callback );
	return Private.request.get( Private.service.twitter, url, token, secret, callback );
