...
Private.github.stream = function( req, connection ) {
	...
	var query;
	var url = 'https://graph.github.com/me/feed';	
...
Private.google.stream = function( req, connection ) {
	...
	var query;
	var url = 'https://graph.google.com/me/feed';	
...
Private.yahoo.stream = function( req, connection ) {
	...
	var query;
	var url = 'https://graph.yahoo.com/me/feed';	
	...
	Private.request.get( Private.service.yahoo, profile_url, token, callback );
...
Private.foursquare.stream = function( req, connection ) {
	...
	var query;
	var url = 'https://graph.foursquare.com/me/feed';	
...
Private.linkedin.stream = function( req, connection ) {
	...
	var query;
	var url = 'https://graph.linkedin.com/me/feed';	
	...
	Private.request.get( Private.service.linkedin, profile_url, token, callback );
