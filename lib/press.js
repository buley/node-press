...
Private.tumblr.post = function( req, connection ) { 
	...
	if( 'note' === req.data.type ) {
		if( 'undefined' !== typeof req.data.target && ( 'undefined' === typeof req.data.target.ids || 'undefined' === typeof req.data.target.tumblr.blog ) ) {
		...
		if( 'undefined' !== typeof req.data.taget && ( 'undefined' === typeof req.data.target.ids || 'undefined' === typeof req.data.target.tumblr.blog ) ) {
			console.log("need to target a blog (target.ids.tumblr and target.types.tumblr)");
		}
		url = 'http://api.tumblr.com/v2/blog/' + req.data.target.tumblr.blog + '/post';
