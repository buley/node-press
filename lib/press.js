...
Private.models.facebook.image = function( image ) {
	return {
		...
		, picture: image.thumbnail.link.url
		, source: image.source.link.url
		, 'type': video
	};
};
...
Private.models.facebook.person = function( person ) {
	//TODO: model and implement is_person	
	return false;
};
...
Private.models.facebook.organization = function( organization ) {
	//TODO: model organization and do is_organization
	return false;
};
...
Private.models.facebook.entity = function( entity ) {
	//TODO: implement entity model and is_entity check
	return false;
};
 ...
 * {
 * 	TODO: https://developers.facebook.com/docs/reference/api/checkin/
 * }
 * */

Private.models.facebook.checkin = function( checkin ) {
	//TODO: implement checkin model and is_checkin check
	return false;
};
...
Private.models.twitter.person = function( person ) {
	//TODO: model and implement person, is_person; map
	return false;
};
...
Private.models.twitter.organization = function( organization ) {
	//TODO: imeplement twitter organization mapping
	return false;
};
...
Private.models.linkedin.person = function( person ) {
	//TODO: implement model and mapping for peson
	return false;	
};
...
Private.models.linkedin.organization = function( organization ) {
	//TODO: implement model and mapping for group
	return false;	
};
...
Private.models.linkedin.entity = function( entity ) {
	//TODO: implement model and mapping for entity
	return false;	
};
...
Private.models.github.person = function( person ) {
	//TODO: implement person and github mappings
	return false;	
};
...
Private.models.github.organization = function( organization ) {
	//TODO: org model and github implementation
	return false;
};
...
Private.models.github.entity = function( entity ) {
	//TODO: entity model and github implementation
	return false;
};
...
Private.models.foursquare.person = function( person ) {
	//TODO: model person and map foursquare person
};
...
Private.models.foursquare.entity = function( entity ) {
	//TODO: implement entity model and map foursquare entity
};
...
Private.models.foursquare.checkin = function( checkin ) {
	//TODO: implement checking model and map foursquare checkin
};
