...
Private.tumblr.post = function( req ) { 
	...
	var callback = function( status_code,data ) {
		...
		var res2 = Private.request.get( Private.service.tumblr, 'https://api.tumblr.com/v2/blog/' + req.data.target.ids.tumblr + '/posts?id=' + item_id, token, secret, function(res2,res3) {
